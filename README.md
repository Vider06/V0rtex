...
```
V0rtex_System/
├── V0RTEX_v0.9.8.X0/               ← main install directory (BASE_DIR)
...
| **Updater says "up to date" on old version** | Update to v0.9.8.X0 — earlier versions had a version comparison bug with alphanumeric tags |
